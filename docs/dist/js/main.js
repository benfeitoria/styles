...
try {
  for (var _iterator = progressBars[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    if (_progressBar.classList.contains("progress-bar--sm") && _progressBar.querySelector('circle')) {
      _progressBar.querySelector('circle').r.baseVal.value = "9";
    } else if (_progressBar.classList.contains("progress-bar--md") && _progressBar.querySelector('circle')) {
      _progressBar.querySelector('circle').r.baseVal.value = "11";
    } else if (_progressBar.classList.contains("progress-bar") && _progressBar.querySelector('circle')) {
...
},{"../../js/main":7,"./components/icons":1,"./components/progressbar":2}],4:[function(require,module,exports){
"use strict";
...
},{"./components/alert":4,"./components/navbar":5,"./components/progressbar":6}]},{},[3]);
